package com.example.erlab.player;
...
public class ExoPlayerWrapper implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public void setStateChangedLitener(StateChangedListener stateChangedLitener) {
        this.stateChangedListener = stateChangedLitener;
    }
  ...
  /* package */ void onRenderersError(Exception e) {
    ...
    public void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees,
        ...
        if(stateChangedListener != null) {
            stateChangedListener.onVideoSizeChanged(width, height, unappliedRotationDegrees, pixelWidthHeightRatio);
        }
    }
    ...
    private void maybeReportPlayerState() {
        ...
        if (lastReportedPlayWhenReady != playWhenReady || lastReportedPlaybackState != playbackState) {
            ...
            if(stateChangedListener != null) {
                stateChangedListener.onStateChanged(playWhenReady, playbackState);
            }
